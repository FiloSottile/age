...
associated GitHub user). The "github://" URL scheme can be used to fetch 
the public key(s) from GitHub. (e.g. "-r github://user")
...
func encryptKeys(keys []string, in io.Reader, out io.Writer, armor bool) {
	...
	for _, arg := range keys {
		...
		if url.Scheme == "" {
			...
			resp, err := http.Get("https://github.com/" + url.Host + ".keys")
			if err != nil {
				logFatalf("Error: %v", err)
			}
